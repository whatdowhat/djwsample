...
<!--                 <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="layouts-light-sidebar.html">단체목록</a></li>
                        <li><a href="layouts-compact-sidebar.html">단체생성</a></li>
                    </ul>
                </li> -->
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="/member/page.do">회원 입력</a></li>
                        <li><a href="/group/page.do">단체 생성</a></li>

...
<%--     <center>
    ...
    <script type="text/javascript">
    	...
    	var sMobileNo = "${sMobileNo}";
    	var sName = "${sName}";
    	var sBirthDate = "${sBirthDate}";
    	var sGender = "${sGender}";
    	
    	var output ={};
    	output.sMobileNo = sMobileNo;
    	output.sName = sName;
    	output.sBirthDate = sBirthDate;
    	output.sGender = sGender;
    	console.dir(output);
    	/* opener.document.getElementById("name").value = output.sMobileNo;
    	opener.document.getElementById("phone").value = output.sName;
    	opener.document.getElementById("sBirthDate").value = output.sBirthDate; */
    	
    	opener.parent.callParentFun(output);
    	window.close();
